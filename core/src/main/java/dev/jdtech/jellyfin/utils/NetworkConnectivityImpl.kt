 ...
 * network that advertises internet capability -- which reliably covers the "no network at all" case
 * (Wi-Fi off). A network that is connected but has no working internet is a rarer edge case the
 * startup check does not try to catch.
 */
