 ...
 * source that gets used and what the UI shows always agree. The manual preference is never written
 * by connectivity detection -- it stays the user's explicit choice, so the app returns to online
