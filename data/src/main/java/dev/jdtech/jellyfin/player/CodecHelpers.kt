...
internal object CodecHelpers {
    fun getVideoCodec(mimeType: String): String? =
        when (mimeType) {
    ...
    fun getAudioCodec(mimeType: String): String? =
        when (mimeType) {
    ...
    fun getVideoProfile(codec: String, profile: Int): String? =
        when (codec) {
    ...
    private fun getMPEG2VideoProfile(profile: Int): String? =
        when (profile) {
    ...
    private fun getH263Profile(profile: Int): String? =
        when (profile) {
    ...
    private fun getMPEG4Profile(profile: Int): String? =
        when (profile) {
    ...
    private fun getAVCProfile(profile: Int): String? =
        when (profile) {
    ...
    private fun getHEVCProfile(profile: Int): String? =
        when (profile) {
    ...
    private fun getVP8Profile(profile: Int): String? =
        when (profile) {
            CodecProfileLevel.VP8ProfileMain -> "main"
            else -> null
        }

    private fun getVP9Profile(profile: Int): String? =
        when (profile) {
    ...
    private fun getMPEG2VideoLevel(level: Int): String? =
        when (level) {
    ...
    private fun getH263Level(level: Int): String? =
        when (level) {
    ...
    private fun getMPEG4Level(level: Int): String? =
        when (level) {
    ...
    private fun getAVCLevel(level: Int): String? =
        when (level) {
    ...
    private fun getHEVCLevel(level: Int): String? =
        when (level) {
    ...
    private fun getVP8Level(level: Int): String? =
        when (level) {
    ...
    private fun getVP9Level(level: Int): String? =
        when (level) {
    ...
    fun getAudioProfile(codec: String, profile: Int): String? =
        when (codec) {
            "aac" -> getAACProfile(profile)
            else -> null
        }

    private fun getAACProfile(profile: Int): String? =
        when (profile) {
